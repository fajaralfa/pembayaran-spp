        ...
        <div class="card-body">
            <form action="" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="nama_kelas" value="<?= $_GET['nama_kelas'] ?>" id="" class="form-control">
                </div>
                <div class="mb-3">
                    <label for="kompetensi_keahlian" class="form-label">Kompetensi Keahlian</label>
                    <input type="text" name="kompetensi_keahlian" value="<?= $_GET['kompetensi_keahlian'] ?>" id="" class="form-control">
                </div>
                <div>
